...
<div style="float: left; text-align: justify; WIDTH: 42%">A laserterapia é um tratamento realizado com um equipamento laser de baixa potência, cuja energia é absorvida pelas células doentes do corpo. Esta energia aumenta a microcirculação local e restabelece a produção da energia celular, promovendo a cicatrização e a ação anti-inflamatória e analgésica no local da irradiação.</div>
<div style="float: right; text-align: justify; WIDTH: 42%">A terapia laser é mais uma opção de tratamento que se pode oferecer na clínica diária. Como toda técnica é fundamental que se conheça bem os seus princípios básicos, principalmente porque os efeitos e o mecanismo de ação do laser são muito mais complexos do que os de uma luz ultravioleta ou um aparelho de ultra-som.</div>
