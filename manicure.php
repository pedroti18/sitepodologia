...
<div style="float: left; text-align: justify; WIDTH: 42%">A manicure é um tratamento cosmético para a beleza das unhas e mãos realizados em casa ou em um salão de beleza. Um tratamento manicure não é apenas um tratamento para as unhas naturais, mas também para as mãos. A manicure consiste da apresentação, a modelagem da borda livre, tratamentos, massagem da mão e da aplicação do esmalte.</div>
<div style="float: right; text-align: justify; WIDTH: 42%">Há também serviços de manicure que são as especialidades para as mãos e pés. Para as mãos, na embebição de uma substância de amolecimento e a aplicação de uma loção é uma especialidade comum. Quando aplicado às unhas dos pés, este tratamento é referido como um pedicure. A palavra "manicure" deriva do latim: manus para "mão", cura para o "cuidado".</div>
