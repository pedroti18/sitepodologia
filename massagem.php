...
<div style="float: left; text-align: justify; WIDTH: 42%">É a prática de aplicar força ou vibração sobre tecidos macios do corpo, incluindo músculos, tecidos conectivos, tendões, ligamentos e articulações, para estimular a circulação sanguínea, a mobilidade, a elasticidade ou alívio de determinadas dores corporais.</div>
<div style="float: right; text-align: justify; WIDTH: 42%">Por ser uma forma de terapia, também pode ser conhecida como massoterapia. Pode ser aplicada a partes do corpo ou continuamente a todo o corpo, para aliviar traumas físicos, aliviar estresse psicológico, controlar a dor, melhorar a circulação e aliviar a tensão nervosa.</div>
